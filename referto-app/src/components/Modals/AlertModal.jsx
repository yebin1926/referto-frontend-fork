...
const AlertModal = ({icon, color, handleAlertCancel, text}) => {
  ...
  <>
    ...
    <div className={`fixed top-0 left-1/2 transform -translate-x-1/2 w-[450px] h-[39px] px-[15px] py-3 bg-white shadow border-t-2 border-${color} flex-col justify-start items-start gap-7 inline-flex z-50`}>
