    ...
    >
      {selectedAssignmentId === assignmentId ? (
        <div className="bg-neutral-300 rounded-[20px] flex items-center justify-start gap-1.5 px-3.5 py-2.5 relative self-stretch w-full flex-[0_0_auto] overflow-hidden">
          ...
          <div className="font-bold text-neutral-700 leading-6 text-lg tracking-0 truncate">
          {isEdit ? (
            <input
        ...
        >
          ...
          <div className="font-bold text-neutral-400 leading-6 text-lg tracking-0 truncate max-w-[calc(100%-40px)]">
            {content}
          </div>
        </Link>
      )}
